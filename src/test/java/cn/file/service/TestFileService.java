...
public class TestFileService {
    ...
    public void testInsertWechatInfo() {
		...
		int id = fileService.insertWechatUserInfo(bean);
	...
	public void testGetWechatUserInfoById() {
		...
		result = fileService.getWechatUserInfoById(1);
	...
	public void testAllWechatUserInfoBeanList() {
		WechatUserInfoBean result = null;
		List<WechatUserInfoBean> list = fileService.getAllWechatUserInfoBeanList();
...
//        UserRegInfo info = fileService.addNewUser(userRegInfo);
...
//        Token token = fileService.getAccessToken(userId);
//        String accessToken =  token.getAccessToken();
////        String accessToken = "fdb853e911899cf3d3dd2c22e2543edb";
//        System.out.println(accessToken);
//        String refreshToken = token.getRefreshToken();
//        System.out.println("refreshToken = "+refreshToken);
////        String realToken = fileService.getAccessTokenByUserId(userId);
...
////        System.out.println( fileService.isAccessTokenValidate(accessToken, userId+""));
////        String newToken = fileService.getAccessTokenByRefreshToken(userId+"", refreshToken).get("accessToken");
...
//        long flag = fileService.addBindOpenid(userOpenidBean);
...
//        long flag = fileService.cancelBindOpenid(userOpenidBean);
//        Assert.assertEquals(flag, 1);
//    }
//    
//    
...
////        Token token =  fileService.getAccessToken(1);
...
//        String openid = fileService.getOpenidByUserId(878669);
//        //String openid = fileService.getOpenidByUserId(0);
//        //String openid  = fileService.getOpenidByUserId(-1);
...
//        DeviceBean deviceBean = fileService.getDevice("w345wrgqery42562346arqgf", 1);
...
//        //fileService.addDevice("r124wrerjng42562346advdx", -1, 456321);
//        fileService.addDevice("r124wrerjng42562346advdx", 2, 456321);
//    }
//    
//    @Test
//    public void testUpdateDevice() {
//        boolean flag = fileService.updateDevice("r124wrerjng42562346advdx", 2, 789987);
